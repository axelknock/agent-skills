...
description: Use colgrep for semantic code search as the primary search tool instead of Search/Grep/Glob. Use when finding code by intent, exploring systems, combining text and semantic filters, or narrowing searches by file patterns and paths.
---

# Semantic Code Search

Use `colgrep` as the primary code search tool instead of `Search / Grep / Glob`.
